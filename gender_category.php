<?php
    ...
    if (isset($_GET['discountproductsprice'])) {

      $get_product_category = $_GET['discountproductsprice'];

      $query = "SELECT * FROM products  WHERE product_new_price < 30.00 ORDER BY created_at DESC limit 30";
